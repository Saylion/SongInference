...
### Mod version notebook

[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Saylion/SongInverence/blob/main/Song_Inference.ipynb)
...
Once the output message says `Scan complete. There is [TOTAL MODELS] models available`, You can choose several models that can be copied in the available models dropdown (multichoice allowed), you can also select all. Finnaly you can click `Copy model` and wait the process, navigate in the `Generate` tab and click refresh models button
